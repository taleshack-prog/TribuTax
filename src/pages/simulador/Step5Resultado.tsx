...
export function Step5Resultado({ resultado, faturamento, onNext, onBack, onReiniciar }: Props) {
  const {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white px-6 py-10 max-w-2xl mx-auto">
      ...
      <h2 className="font-display font-bold text-2xl mb-1">Resultado da Simulação</h2>
      ...
      {/* Gráfico Carga */}
      <Card className="mb-4">
        <p className="text-sm font-medium text-zinc-300 mb-4">Carga Tributária: Atual vs Nova</p>
      ...
      {/* Gráfico Margem */}
      <Card className="mb-6">
        <p className="text-sm font-medium text-zinc-300 mb-4">Margem Operacional: Atual vs Projetada</p>
        <ResponsiveContainer width="100%" height={140}>
      ...
      {precoNeutro > 0 && (
        <Card gold className="mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-zinc-400">Preço necessário para manter margem atual</p>
      ...
      <div className={`rounded-xl border p-5 mb-6 ${RISCO_BG[nivelRisco]}`}>
        <div className="flex items-center gap-2 mb-3">
          ...
          <p className={`font-display font-semibold ${RISCO_COLOR[nivelRisco]}`}>
